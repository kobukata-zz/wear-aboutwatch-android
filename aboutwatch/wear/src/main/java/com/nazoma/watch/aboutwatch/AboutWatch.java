package com.nazoma.watch.aboutwatch;
...
public class AboutWatch extends CanvasWatchFaceService {
    private static final String TAG = "AboutWatch";
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(AboutWatch.this)
                    .setCardPeekMode(WatchFaceStyle.PEEK_MODE_VARIABLE)
                    .setBackgroundVisibility(WatchFaceStyle.BACKGROUND_VISIBILITY_INTERRUPTIVE)
                    .setShowSystemUiTime(false)
                    .build());

            Resources resources = AboutWatch.this.getResources();
            mTextPaint = new Paint();
            mTextPaint.setColor(resources.getColor(R.color.digital_text));
            mTextPaint.setTypeface(Typeface.createFromAsset(AboutWatch.this.getResources().getAssets(), "PixelMplus12-Regular.ttf"));
        ...
        private void registerReceiver() {
            ...
            AboutWatch.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            AboutWatch.this.unregisterReceiver(mTimeZoneReceiver);
        }
